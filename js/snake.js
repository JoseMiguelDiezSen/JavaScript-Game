            ...
            function recordScore () {
                ...
                if (me.snakeLength > highScore) {
                    alert('Congratulations! You have beaten your previous high score, which was ' + highScore + '.');
                        ...
                        localStorage.removeItem('jsSnakeHighScore', me.snakeLength);
                }
}
    ...
    */
    ...
    return function(inputConfig) {
        ...
        var me = this,
            myId = instanceNumber++,
            config = inputConfig || {},
            MAX_BOARD_COLS = 100,//Aqui el ancho del tablero
            MAX_BOARD_ROWS = 100,//Aqui el largo
            blockWidth = 10,
            blockHeight = 10,
        ...
        function createBoardElements() {
            ...
            elmPauseScreen.innerHTML = "<div style='padding:10px;'>Pausa!!<p/>Presiona [Espacio] para volver al juego.</div>";
        ...
        function createWelcomeElement() {
            ...
            welcomeTxt.innerHTML = "JavaScript Snake<p></p>Los controles de Snake son <strong>las flechas </strong> del teclado" + fullScreenText + "<p></p>";
        ...
        function createTryAgainElement() {
            ...
            tryAgainTxt.innerHTML = "JavaScript Snake<p></p>Has matado a Snake :(<p></p>";
            var tryAgainStart = document.createElement("button");
            tryAgainStart.appendChild( document.createTextNode("¿Jugar de Nuevo?"));
        ...
        */
        ...
        /**
        * Este metodo es llamado cuando la serpiente come.
        * @method foodEaten
        */
        me.foodEaten = function() {
            ...
            /*elmLengthPanel.innerHTML = "Puntuación: " + mySnake.snakeLength;*/
        ...
        /**
        * Este metodo es llamado cuando la serpiente muere.
        * @method handleDeath
        */
        me.handleDeath = function() {
...
function getHighScore () {
    ...
    alert('Tu actual puntuación mas alta es:' + localStorage.jsSnakeHighScore + '.'); });
}
getHighScore();
...
function actualizarPuntuacion(){
    ...
    puntuacion +=5; 
            ...
            document.getElementById("puntuacion").innerHTML = ("PUNTUACION: "+puntuacion.value);
            }